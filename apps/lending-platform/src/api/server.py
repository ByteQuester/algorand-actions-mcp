...
from .escrow_router import router as escrow_router
from .audit_router import router as audit_router, startup_audit_service, shutdown_audit_service
from .websocket_router import router as websocket_router
from .traceability_router import router as traceability_router
from ..core.audit.event_streaming import get_event_streaming_service, shutdown_event_streaming_service
...
async def startup_event():
    ...
    try:
        ...
        await startup_audit_service()

        # Initialize event streaming service
        await get_event_streaming_service()
...
async def shutdown_event():
    ...
    try:
        ...
        # Cleanup event streaming service
